...
**獎勵計算規則（全新優化標準）：**
- 單字任務：3 + 難度加成(8-12劃+1, 13-16劃+2, 17-19劃+3, 20+劃+4) + 次數加成(5-7次+1, 8次+2, 9-10次+3)，上限10
- 詞語書寫：基礎5 + 複雜度加成(25-29筆畫+1, 30+筆畫+2)，上限9，範圍6-9學習幣
- 詞語造句應用：基礎6 + 複雜度加成(18-24筆畫或2字+1, 25+筆畫或3字+2)，上限10，範圍7-10學習幣
...
**國小${request.grade}年級範例（全新獎勵標準）：**
- 單字範例：「聰」(17劃，練習7次) → 獎勵：3+3+1=7學習幣
- 詞語書寫範例：「美麗」(總28筆畫，練習6次) → 獎勵：5+1=6學習幣
- 詞語造句應用範例：「努力」(總22筆畫，2字) → 「請用『努力』造一個完整的句子，展現努力的意思」→ 獎勵：6+1=7學習幣
